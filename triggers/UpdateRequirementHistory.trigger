Trigger UpdateRequirementHistory on Requirements__c ( before update) {
...
if (((oldValueDesc != newValueDesc ) && (newValueDesc != null))|| ((oldValueDesc != newValueDesc ) && (oldValueDesc == null|| oldValueDesc == '')) ){
